...
public class BasePage {
	...
	public void submitForm(WebDriver driver, String locatorType) {
		this.getWebElement(driver,locatorType).submit();
	...
	public void switchToFrameIframe(WebDriver driver, String locatorType) {
 	...
 	public void rightClickToElement(WebDriver driver, String locatorType ,int X, int Y) {
 		Actions action =  new Actions(driver);
 		action.moveToElement(getWebElement(driver, locatorType)).moveByOffset(X, Y).contextClick().build().perform();
 	}
 	
 	public void clickToCoordinates(WebDriver driver, String locatorType, int X, int Y) {
 		Actions action =  new Actions(driver);
	...
	public void waitingLoadingIcon(WebDriver driver) { 
	 overrideImplicitTimeout(driver, 2);
	 getWebElement(driver, LOADING_ICON);
	 waitForElementInvisible(driver, LOADING_ICON);
	}
   ...
   // Wait for Element undisplayed in DOM or not in DOM and override implicit timeout
	...
	public static final String LOADING_ICON = "XPath=//*[@class='loading ng-star-inserted']";
